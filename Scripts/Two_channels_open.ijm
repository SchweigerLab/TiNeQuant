...
selectImage("C2_subtracted_"+a+"");
//Multiply pixel values with 255 to get 0-255 segmentation and not 0-1
run("Multiply...", "value=255 stack");
//Removal of small particles (salt and pepper noise)
...
//Channel 2 quantification
Table.set ("Nr", 0, a);
Table.set ("Image", 0, "Channel_1_"+filename+"");
Table.set ("Total length",0, b);
Table.set ("Unit", 0, "µm");
//Channel 1 quantification 
Table.set ("Nr", 1, a+1);
Table.set ("Image", 1, "Channel_2_"+filename+"");
Table.set ("Total length", 1, c);
Table.set ("Unit", 1, "µm");
//Lobevolume quantification
Table.set ("Nr", 2, a+2);
Table.set ("Image", 2, "Lobevolume_"+filename+"");
Table.set ("Total length", 2, Lobevolume);
Table.set ("Unit", 2, "µm^3");
//Prepare the results table and show the monatage for optical evaluation
selectWindow("Skeleton results");
Table.sort("Nr");
close("Results");
